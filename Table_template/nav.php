<nav class="navbar navbar-expand-sm navbar-dark pt-5">
        <a class="navbar-brand text-light" href="../index.php"><b>Job Portal</b></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
          <ul class="navbar-nav mr-auto ">
            <li class="nav-item ml-4 active ">
              <a class="nav-link text-light" href="classes/class.php">Class </a>
            </li>
            <li class="nav-item ml-4 active">
              <a class="nav-link text-light" href="teachers/teacher.php">Teacher </a>
            </li>
            <li class="nav-item ml-4 active">
              <a class="nav-link text-light" href="students/student.php">Student </a>
            </li>
          </ul>
