    ...
    <?php include("nav.php")?>
      ...
      <div class="container-fluid bg-light pt-5 pb-5">
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-3 ">
              <img src="assets/image/Capture1.PNG" alt="Capture1">
            ...
            <div class="col-md-3 ">
              <img src="assets/image/Capture2.PNG" alt="Capture1">
              <p>Search Millions of Jobs</p>
              <p class="text-secondary"><small>A small river named Duden flows <br> by their place and supplies.</small></p>
            </div>
            <div class="col-md-3 ">
              <img src="assets/image/Capture3.PNG" alt="Capture1">
              <p>Search Millions of Jobs</p>
              <p class="text-secondary"><small>A small river named Duden flows <br> by their place and supplies.</small></p>
            </div>
            <div class="col-md-3 ">
              <img src="assets/image/Capture4.PNG" alt="Capture1">
              <p>Search Millions of Jobs</p>
              <p class="text-secondary"><small>A small river named Duden flows <br> by their place and supplies.</small></p>
            </div>
          </div>
        ...
        <div class="container mt-5">
          ...
          <div class="row">
            <div class="col-md-12 p-3 mt-5 shadow-lg" style="background: white;">
              ...
              <p class="mt-3 text-primary"><img src="assets/image/1.PNG" alt="1">Facebook, Inc. <img src="assets/image/2.PNG" alt="2" ><span class="text-secondary"> Western City, UK</span></p>
              <button class="btn  btn-primary" style="float: right; margin-top: -50px; margin-right: 50px;">Apply Job</button><img src="assets/image/3.PNG" alt="3" style="float: right; margin-top: -50px;">
            </div>
            <div class="col-md-12 p-3 mt-5 shadow-lg" style="background: white;">
              <h3> Full Stack Developer <span class="badge   rounded-pill bg-warning text-light"><small> Full Time</small></span></h3>
              <p class="mt-3 text-primary"><img src="assets/image/1.PNG" alt="1">Facebook, Inc. <img src="assets/image/2.PNG" alt="2" ><span class="text-secondary"> Western City, UK</span></p>
              <button class="btn  btn-primary" style="float: right; margin-top: -50px; margin-right: 50px;">Apply Job</button><img src="assets/image/red.PNG" alt="3" style="float: right; margin-top: -50px;">
            </div>
            <div class="col-md-12 p-3 mt-5 shadow-lg" style="background: white;">
          ...
          <a href="#"><span><img src="assets/image/00.PNG" alt=""></span></a>
          </div>
        </div>
      </div>
      ...
      <div class="container mt-5 pt-5 pb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mt-5">
            <img src="assets/image/22.PNG" alt="11">
            <p class="text-secondary" style="font-size: small;">Far far away, behind the word mountains, far <br> from the countries Vokalia and Consonantia, <br> there live the blind texts.</p>
            <p>Roger Scott</p>
            <p class="text-secondary" style="font-size: small;">Marketing Manager</p>
          </div>
          <div class="col-md-4 mt-5">
            <img src="assets/image/33.PNG" alt="11">
            <p class="text-secondary" style="font-size: small;">Far far away, behind the word mountains, far <br> from the countries Vokalia and Consonantia, <br> there live the blind texts.</p>
            <p>Roger Scott</p>
            <p class="text-secondary" style="font-size: small;">Marketing Manager</p>
          </div>
        ...
        <div class="container mt-5">
          ...
          <div class="row">
            <div class="col-md-3 mt-5">
              <img src="assets/image/ximage_1.jpg.pagespeed.ic.cY8J7mM7KW.webp" alt="xbg_1" width="100%">
            ...
            <div class="col-md-3 mt-5">
              <img src="assets/image/ximage_2.jpg.pagespeed.ic.KiEvuOw7R2.webp" alt="xbg_1" width="100%">
              <p class="text-secondary" style="font-size: small;">DECEMBER 2, 2018 ADMIN</p>
              <p>Even the all-powerful Pointing has no control about the blind texts</p>
              <p class="text-secondary" style="font-size: small;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias architecto enim non iste maxime optio, ut com</p>
            </div>
            <div class="col-md-3 mt-5">
              <img src="assets/image/ximage_3.jpg.pagespeed.ic.-BUz1LQ4Y6.webp" alt="xbg_1" width="100%">
              <p class="text-secondary" style="font-size: small;">DECEMBER 2, 2018 ADMIN</p>
              <p>Even the all-powerful Pointing has no control about the blind texts</p>
              <p class="text-secondary" style="font-size: small;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias architecto enim non iste maxime optio, ut com</p>
            </div>
            <div class="col-md-3 mt-5">
              <img src="assets/image/ximage_4.jpg.pagespeed.ic.OKt2EKLAhd.webp" alt="xbg_1" width="100%">
              <p class="text-secondary" style="font-size: small;">DECEMBER 2, 2018 ADMIN</p>
              <p>Even the all-powerful Pointing has no control about the blind texts</p>
              <p class="text-secondary" style="font-size: small;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias architecto enim non iste maxime optio, ut com</p>
            </div>
