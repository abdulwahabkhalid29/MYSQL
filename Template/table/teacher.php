...
<div class="container-fluid bg-light back">
    ...
    <?php include("nav.php")?>
        ...
        <div class="container pt-5">
            <h1 class="text-dark text-center pb-5">TEACHER_TABLE</h1>
            
    <div class="mt-5">
            <a href="teacher_create.php"><button class="btn btn-success float-right pl-5 pr-5 mb-5 ">MYSQL Form Data</button></a>
    </div>
